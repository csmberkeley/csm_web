...
@pytest.mark.parametrize(
    "to_emails",
    ["test@email.com", ["test@email.com"], ["test@email.com", "example@email.com"]],
)
@pytest.mark.parametrize(
    "cc_emails",
    ["test2@email.com", ["test2@email.com"], ["test2@email.com", "example2@email.com"]],
)
@pytest.mark.parametrize(
    "bcc_emails",
    ["test3@email.com", ["test3@email.com"], ["test3@email.com", "example3@email.com"]],
)
...
def test_send_email(subject, body, to_emails, cc_emails, bcc_emails):
    encoded_message = _email_send_message(
        subject, body, to_emails, cc_emails, bcc_emails
    )
