...
rest_urlpatterns = [
    ...
    path("flag/", views.CreateFlag.as_view()),
    path("flag/<int:pk>/toggle", views.ToggleFlag.toggle_flag, name="toggle"),
    path("room_availability", views.CreateRoomAvailability.as_view()),
