...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--complicated', action='store_true', dest='complicated', help='Complicate data by allowing users to have multiple profiles, potentially across different courses or roles.')
